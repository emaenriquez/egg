...
-- 8. Lista los nombres de los productos ordenados en primer lugar por el nombre de forma ascendente y en segundo lugar por el precio de forma 
-- descendente.
...
-- 1. Devuelve una lista con el código del producto, nombre del producto, código del fabricante y nombre del fabricante, de todos 
-- los productos de la base de datos.
-- select codigo,nombre from fabricante; select nombre,codigo_fabricante from producto;

select fabricante.codigo,producto.nombre,fabricante.nombre, producto.codigo_fabricante from producto
...
-- los productos que tengan un precio mayor o igual a $180. Ordene el resultado en primer lugar por el precio (en orden descendente) 
...
-- 1. Devuelve un listado de todos los fabricantes que existen en la base de datos, junto con los productos que tiene cada
